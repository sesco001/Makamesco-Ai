...
module.exports = { session: process.env.SESSION_ID || 'sessionid',
    ...
    DEV : process.env.DEV || "MAKAMESCOMD",
    ...
    AUTO_STICKER : process.env.AUTO_STICKER || "no", 
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'Your Status Seen By MAKAMESCO-MD-XFORCE',   
    ...
    BOT : process.env.BOT_NAME || 'MAKAMESCO-MD',
