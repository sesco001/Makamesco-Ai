...
module.exports = { session: process.env.SESSION_ID || 'sessionid',
    ...
    OWNER_NAME : process.env.OWNER_NAME || "MESHACK MATHEKA",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "254769995625",
    DEV : process.env.DEV || "Untoldman😎",
    ...
    AUTO_STICKER : process.env.AUTO_STICKER || "no", 
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'Your Status Seen By Untoldman😎',   
    ...
    CAPTION : process.env.CAPTION || "Untoldman😎",
    BOT : process.env.BOT_NAME || 'Untoldman😎',
