...
const  {addGroupToBanList,isGroupBanned,removeGroupFromBanList} = require("../fredie/banGroup");
const {isGroupOnlyAdmin,addGroupToOnlyAdminList,removeGroupFromOnlyAdminList} = require("../fredie/onlyAdmin");
const {removeSudoNumber,addSudoNumber,issudo} = require("../fredie/sudo");
...
ezra({ nomCom: "kickall", categorie: 'Dave-Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
